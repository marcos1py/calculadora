...
class Calculadora(QMainWindow):
    def __init__(self, parent = None):
        ...
        self.setWindowTitle("CALCULADORA DO NAMORADO DA GOSTOSA")
    ...
    def add_botao(self, btn, fileira, número_da_coluna, número_de_linhas, numero_de_colunas, funcao=None, style=None):
        self.grid.addWidget(btn, fileira, número_da_coluna, número_de_linhas, numero_de_colunas)
        if not funcao:
            btn.clicked.connect(
                lambda: self.display.setText(
